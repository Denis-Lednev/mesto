...
export const editButton = page.querySelector(".profile-info__edit-button");
export const nameInput = page.querySelector(".popup__item_el_name");
export const jobInput = page.querySelector(".popup__item_el_status");
...
export const addButton = page.querySelector(".add-button");
