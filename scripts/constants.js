...
export const buttonEditProfile = page.querySelector(".profile-info__edit-button");
...
export const buttonsClosePopup = document.querySelectorAll(".close-button"); 
export const buttonAddNewCard = page.querySelector(".add-button"); 
